...
## Comandos
```
sudo <comando>								// Comando Como Administrador
```
...
&	 										// Usar dois comandos com duas saidas no terminal(Quebra os processos)
&&	 										// Usar dois comandos com uma saida no terminal (Os dois consecutivos)
```
...
```
<comando> <Comeco do nome> + Tab			// Autocomplete
^ 											// significa Ctrl
M 											// significa Alt
